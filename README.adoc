...
This project is a third part of https://vertx.io/docs/guide-for-java-devs/[A gentle guide to asynchronous programming with Eclipse Vert.x for Java developers].
